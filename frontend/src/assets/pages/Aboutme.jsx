  ...
  return (
    <section id="experience" className="bg-black py-12">
      <div className="container mx-auto px-4">
        <h2 className="text-center text-3xl md:text-5xl uppercase font-semibold text-blue-500 mb-10">About Me</h2>
        <div className="md:grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="md:mx-10">
            {/* Image */}
            {/* <img src="../public/img/skills_photo.avif" className="rounded" alt="Skills" /> */}
          ...
          <div>
            ...
            <div id="details" className="text-white mt-6">
              <div className="ml-5 md:ml-1 md:text-xl md:gap-5 mt-6">
                ...
                <div className="py-2">
                  <a href="tel:+918805601819" className="font-bold">Contact:</a> 8805601816
                </div>
              </div>
